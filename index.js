...
async function fetchDataAndInsert() {
  ...
  await getDataAndInsert('aduan', 'https://script.google.com/macros/s/AKfycbzgzZmqVz7K_IkW_YBXpE30JWK408fx_0FwKntlW4zuAyQi-I5x2KEZ3WeLWmaB5dwC/exec', ['vuelo', 'pri_bag', 'ul_bag', 'cie', 'obs', 'res_a']);
...
fetchDataAndInsert();
setInterval(fetchDataAndInsert, 30000);
